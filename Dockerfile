...
RUN pip3 install beautifulsoup4 css_html_js_minify ipykernel jupyter_client lxml matplotlib nbconvert nbsphinx notebook numpy numpydoc pandas python-slugify[unidecode] recommonmark sphinx-copybutton sphinx sphinx_markdown_tables sphinx-prompt Sphinx-Substitution-Extensions jieba sphinx-prompt sphinx_immaterial pydantic
...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -qy ack-grep
